...
// checks if the KafkaPromoteRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KafkaPromoteRequest{}
...
func (o KafkaPromoteRequest) ToMap() (map[string]interface{}, error) {
