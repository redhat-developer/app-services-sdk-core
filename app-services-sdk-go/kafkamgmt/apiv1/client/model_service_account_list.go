...
// checks if the ServiceAccountList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceAccountList{}
...
func (o ServiceAccountList) ToMap() (map[string]interface{}, error) {
