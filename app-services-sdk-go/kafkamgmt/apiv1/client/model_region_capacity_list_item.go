...
// checks if the RegionCapacityListItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegionCapacityListItem{}
...
func (o RegionCapacityListItem) ToMap() (map[string]interface{}, error) {
