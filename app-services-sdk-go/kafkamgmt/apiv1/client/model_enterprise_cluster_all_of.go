...
// checks if the EnterpriseClusterAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnterpriseClusterAllOf{}
...
func (o EnterpriseClusterAllOf) ToMap() (map[string]interface{}, error) {
