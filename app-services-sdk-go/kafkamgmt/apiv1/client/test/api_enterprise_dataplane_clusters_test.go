...
func Test_kafkamgmtclient_EnterpriseDataplaneClustersApiService(t *testing.T) {
	...
	t.Run("Test EnterpriseDataplaneClustersApiService GetEnterpriseClusterAddonParameters", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var id string

		resp, httpRes, err := apiClient.EnterpriseDataplaneClustersApi.GetEnterpriseClusterAddonParameters(context.Background(), id).Execute()
