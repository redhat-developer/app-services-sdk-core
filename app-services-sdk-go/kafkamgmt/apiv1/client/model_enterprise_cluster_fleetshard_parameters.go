...
// checks if the EnterpriseClusterFleetshardParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnterpriseClusterFleetshardParameters{}
...
func (o EnterpriseClusterFleetshardParameters) ToMap() (map[string]interface{}, error) {
