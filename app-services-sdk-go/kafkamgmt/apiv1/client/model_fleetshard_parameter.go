...
// checks if the FleetshardParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FleetshardParameter{}
...
func (o FleetshardParameter) ToMap() (map[string]interface{}, error) {
