...
// checks if the CloudRegionList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudRegionList{}
...
func (o CloudRegionList) ToMap() (map[string]interface{}, error) {
