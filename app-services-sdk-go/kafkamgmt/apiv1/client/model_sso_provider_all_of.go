...
// checks if the SsoProviderAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SsoProviderAllOf{}
...
func (o SsoProviderAllOf) ToMap() (map[string]interface{}, error) {
