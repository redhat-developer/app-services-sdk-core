...
// checks if the KafkaRequestPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KafkaRequestPayload{}
...
func (o KafkaRequestPayload) ToMap() (map[string]interface{}, error) {
