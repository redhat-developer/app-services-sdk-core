...
// checks if the ServiceAccountListItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceAccountListItem{}
...
func (o ServiceAccountListItem) ToMap() (map[string]interface{}, error) {
