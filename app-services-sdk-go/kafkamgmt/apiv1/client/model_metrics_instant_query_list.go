...
// checks if the MetricsInstantQueryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricsInstantQueryList{}

// MetricsInstantQueryList struct for MetricsInstantQueryList
type MetricsInstantQueryList struct {
	Kind *string `json:"kind,omitempty"`
	Id *string `json:"id,omitempty"`
	Items []MetricsInstantQueryListAllOfItemsInner `json:"items,omitempty"`
}
...
func (o *MetricsInstantQueryList) GetItems() []MetricsInstantQueryListAllOfItemsInner {
	if o == nil || IsNil(o.Items) {
		var ret []MetricsInstantQueryListAllOfItemsInner
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []MetricsInstantQueryListAllOfItemsInner and assigns it to the Items field.
...
func (o MetricsInstantQueryList) ToMap() (map[string]interface{}, error) {
