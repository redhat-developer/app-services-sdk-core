...
// checks if the ServiceAccountListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceAccountListAllOf{}

// ServiceAccountListAllOf struct for ServiceAccountListAllOf
type ServiceAccountListAllOf struct {
	Kind string `json:"kind"`
	Items []ServiceAccountListAllOfItemsInner `json:"items"`
}
...
func (o *ServiceAccountListAllOf) GetItems() []ServiceAccountListAllOfItemsInner {
	if o == nil {
		var ret []ServiceAccountListAllOfItemsInner
		return ret
	}
...
func (o ServiceAccountListAllOf) ToMap() (map[string]interface{}, error) {
