...
// checks if the SupportedKafkaBillingModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportedKafkaBillingModel{}
...
func (o SupportedKafkaBillingModel) ToMap() (map[string]interface{}, error) {
