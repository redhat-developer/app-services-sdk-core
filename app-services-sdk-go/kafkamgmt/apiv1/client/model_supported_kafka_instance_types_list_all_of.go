...
// checks if the SupportedKafkaInstanceTypesListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportedKafkaInstanceTypesListAllOf{}
...
type SupportedKafkaInstanceTypesListAllOf struct {
	InstanceTypes []SupportedKafkaInstanceTypesListAllOfInstanceTypesInner `json:"instance_types,omitempty"`
}
...
func (o *SupportedKafkaInstanceTypesListAllOf) GetInstanceTypes() []SupportedKafkaInstanceTypesListAllOfInstanceTypesInner {
	if o == nil || IsNil(o.InstanceTypes) {
		var ret []SupportedKafkaInstanceTypesListAllOfInstanceTypesInner
		return ret
	}
...
// SetInstanceTypes gets a reference to the given []SupportedKafkaInstanceTypesListAllOfInstanceTypesInner and assigns it to the InstanceTypes field.
...
func (o SupportedKafkaInstanceTypesListAllOf) ToMap() (map[string]interface{}, error) {
