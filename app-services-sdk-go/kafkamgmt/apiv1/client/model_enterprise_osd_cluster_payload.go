...
// checks if the EnterpriseOsdClusterPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnterpriseOsdClusterPayload{}
...
func (o EnterpriseOsdClusterPayload) ToMap() (map[string]interface{}, error) {
