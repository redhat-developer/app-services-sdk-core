...
// checks if the KafkaUpdateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KafkaUpdateRequest{}
...
func (o KafkaUpdateRequest) ToMap() (map[string]interface{}, error) {
