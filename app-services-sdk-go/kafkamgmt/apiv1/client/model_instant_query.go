...
// checks if the InstantQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstantQuery{}
...
func (o InstantQuery) ToMap() (map[string]interface{}, error) {
