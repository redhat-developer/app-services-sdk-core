...
// checks if the SupportedKafkaInstanceTypesList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportedKafkaInstanceTypesList{}
...
func (o SupportedKafkaInstanceTypesList) ToMap() (map[string]interface{}, error) {
