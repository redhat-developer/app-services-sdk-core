...
// checks if the CloudProviderList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudProviderList{}
...
func (o CloudProviderList) ToMap() (map[string]interface{}, error) {
