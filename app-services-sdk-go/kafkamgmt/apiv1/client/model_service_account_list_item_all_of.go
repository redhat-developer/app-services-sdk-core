...
// checks if the ServiceAccountListItemAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceAccountListItemAllOf{}
...
func (o ServiceAccountListItemAllOf) ToMap() (map[string]interface{}, error) {
