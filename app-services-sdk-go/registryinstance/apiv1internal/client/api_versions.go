 ...
 * A server error occurred (HTTP error `500`)
	...
	*/
	DeleteArtifactVersion(ctx context.Context, groupId string, artifactId string, version string) ApiDeleteArtifactVersionRequest

	// DeleteArtifactVersionExecute executes the request
	DeleteArtifactVersionExecute(r ApiDeleteArtifactVersionRequest) (*http.Response, error)
