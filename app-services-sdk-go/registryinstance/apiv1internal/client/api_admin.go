...
* A server error occurred (HTTP error `500`)
	...
	*/
	ListArtifactTypes(ctx context.Context) ApiListArtifactTypesRequest

	// ListArtifactTypesExecute executes the request
	//  @return []ArtifactTypeInfo
	ListArtifactTypesExecute(r ApiListArtifactTypesRequest) ([]ArtifactTypeInfo, *http.Response, error)
