...
func Test_registryinstanceclient_VersionsApiService(t *testing.T) {
	...
	t.Run("Test VersionsApiService DeleteArtifactVersion", func(t *testing.T) {
		...
		httpRes, err := apiClient.VersionsApi.DeleteArtifactVersion(context.Background(), groupId, artifactId, version).Execute()
	...
	t.Run("Test VersionsApiService UpdateArtifactVersionState", func(t *testing.T) {
		...
		httpRes, err := apiClient.VersionsApi.UpdateArtifactVersionState(context.Background(), groupId, artifactId, version).Execute()
