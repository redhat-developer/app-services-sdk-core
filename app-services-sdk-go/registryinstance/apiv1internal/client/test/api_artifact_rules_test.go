...
func Test_registryinstanceclient_ArtifactRulesApiService(t *testing.T) {
	...
	t.Run("Test ArtifactRulesApiService CreateArtifactRule", func(t *testing.T) {
		...
		httpRes, err := apiClient.ArtifactRulesApi.CreateArtifactRule(context.Background(), groupId, artifactId).Execute()
	...
	t.Run("Test ArtifactRulesApiService DeleteArtifactRule", func(t *testing.T) {
		...
		httpRes, err := apiClient.ArtifactRulesApi.DeleteArtifactRule(context.Background(), groupId, artifactId, rule).Execute()
	...
	t.Run("Test ArtifactRulesApiService DeleteArtifactRules", func(t *testing.T) {
		...
		httpRes, err := apiClient.ArtifactRulesApi.DeleteArtifactRules(context.Background(), groupId, artifactId).Execute()
	...
	t.Run("Test ArtifactRulesApiService TestUpdateArtifact", func(t *testing.T) {
		...
		httpRes, err := apiClient.ArtifactRulesApi.TestUpdateArtifact(context.Background(), groupId, artifactId).Execute()
