...
func Test_registryinstanceclient_ArtifactsApiService(t *testing.T) {
	...
	t.Run("Test ArtifactsApiService DeleteArtifact", func(t *testing.T) {
		...
		httpRes, err := apiClient.ArtifactsApi.DeleteArtifact(context.Background(), groupId, artifactId).Execute()
	...
	t.Run("Test ArtifactsApiService DeleteArtifactsInGroup", func(t *testing.T) {
		...
		httpRes, err := apiClient.ArtifactsApi.DeleteArtifactsInGroup(context.Background(), groupId).Execute()
	...
	t.Run("Test ArtifactsApiService UpdateArtifactState", func(t *testing.T) {
		...
		httpRes, err := apiClient.ArtifactsApi.UpdateArtifactState(context.Background(), groupId, artifactId).Execute()
