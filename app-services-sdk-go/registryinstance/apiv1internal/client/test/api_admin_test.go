...
func Test_registryinstanceclient_AdminApiService(t *testing.T) {
	...
	t.Run("Test AdminApiService CreateGlobalRule", func(t *testing.T) {
		...
		httpRes, err := apiClient.AdminApi.CreateGlobalRule(context.Background()).Execute()
	...
	t.Run("Test AdminApiService CreateRoleMapping", func(t *testing.T) {
		...
		httpRes, err := apiClient.AdminApi.CreateRoleMapping(context.Background()).Execute()
	...
	t.Run("Test AdminApiService DeleteAllGlobalRules", func(t *testing.T) {
		...
		httpRes, err := apiClient.AdminApi.DeleteAllGlobalRules(context.Background()).Execute()
	...
	t.Run("Test AdminApiService DeleteGlobalRule", func(t *testing.T) {
		...
		httpRes, err := apiClient.AdminApi.DeleteGlobalRule(context.Background(), rule).Execute()
	...
	t.Run("Test AdminApiService DeleteRoleMapping", func(t *testing.T) {
		...
		httpRes, err := apiClient.AdminApi.DeleteRoleMapping(context.Background(), principalId).Execute()
	...
	t.Run("Test AdminApiService ImportData", func(t *testing.T) {
		...
		httpRes, err := apiClient.AdminApi.ImportData(context.Background()).Execute()
	...
	t.Run("Test AdminApiService ResetConfigProperty", func(t *testing.T) {
		...
		httpRes, err := apiClient.AdminApi.ResetConfigProperty(context.Background(), propertyName).Execute()
	...
	t.Run("Test AdminApiService UpdateConfigProperty", func(t *testing.T) {
		...
		httpRes, err := apiClient.AdminApi.UpdateConfigProperty(context.Background(), propertyName).Execute()
	...
	t.Run("Test AdminApiService UpdateRoleMapping", func(t *testing.T) {
		...
		httpRes, err := apiClient.AdminApi.UpdateRoleMapping(context.Background(), principalId).Execute()
