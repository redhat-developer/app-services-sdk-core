...
* The group already exist (HTTP error `409`)
	...
	*/
	...
	CreateGroupExecute(r ApiCreateGroupRequest) (*GroupMetaData, *http.Response, error)
...
* The group does not exist (HTTP error `404`)
	...
	*/
	DeleteGroupById(ctx context.Context, groupId string) ApiDeleteGroupByIdRequest

	// DeleteGroupByIdExecute executes the request
	DeleteGroupByIdExecute(r ApiDeleteGroupByIdRequest) (*http.Response, error)
...
* A server error occurred (HTTP error `500`)
	...
	*/
	GetGroupById(ctx context.Context, groupId string) ApiGetGroupByIdRequest

	// GetGroupByIdExecute executes the request
	//  @return GroupMetaData
	GetGroupByIdExecute(r ApiGetGroupByIdRequest) (*GroupMetaData, *http.Response, error)
	...
	*/
	...
	ListGroupsExecute(r ApiListGroupsRequest) (*GroupSearchResults, *http.Response, error)
}
