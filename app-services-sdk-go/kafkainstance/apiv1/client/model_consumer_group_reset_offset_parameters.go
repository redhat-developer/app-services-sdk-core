...
// checks if the ConsumerGroupResetOffsetParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerGroupResetOffsetParameters{}
...
func (o ConsumerGroupResetOffsetParameters) ToMap() (map[string]interface{}, error) {
