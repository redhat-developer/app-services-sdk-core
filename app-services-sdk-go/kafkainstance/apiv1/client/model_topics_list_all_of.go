...
// checks if the TopicsListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TopicsListAllOf{}
...
func (o TopicsListAllOf) ToMap() (map[string]interface{}, error) {
