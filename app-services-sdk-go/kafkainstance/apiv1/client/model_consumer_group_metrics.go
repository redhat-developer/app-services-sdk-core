...
// checks if the ConsumerGroupMetrics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerGroupMetrics{}
...
func (o ConsumerGroupMetrics) ToMap() (map[string]interface{}, error) {
