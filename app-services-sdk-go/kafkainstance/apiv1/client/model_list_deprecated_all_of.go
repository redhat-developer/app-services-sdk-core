...
// checks if the ListDeprecatedAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListDeprecatedAllOf{}
...
func (o ListDeprecatedAllOf) ToMap() (map[string]interface{}, error) {
