...
// checks if the TopicsToResetOffset type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TopicsToResetOffset{}
...
func (o TopicsToResetOffset) ToMap() (map[string]interface{}, error) {
