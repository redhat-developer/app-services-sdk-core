...
// checks if the AclBindingListPageAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AclBindingListPageAllOf{}
...
func (o AclBindingListPageAllOf) ToMap() (map[string]interface{}, error) {
