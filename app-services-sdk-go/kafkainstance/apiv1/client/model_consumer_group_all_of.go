...
// checks if the ConsumerGroupAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerGroupAllOf{}
...
func (o ConsumerGroupAllOf) ToMap() (map[string]interface{}, error) {
