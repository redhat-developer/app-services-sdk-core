...
// checks if the NewTopicInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewTopicInput{}
...
func (o NewTopicInput) ToMap() (map[string]interface{}, error) {
