...
// checks if the ConsumerGroupList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerGroupList{}
...
func (o ConsumerGroupList) ToMap() (map[string]interface{}, error) {
