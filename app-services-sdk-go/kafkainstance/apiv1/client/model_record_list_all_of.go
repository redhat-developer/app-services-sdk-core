...
// checks if the RecordListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordListAllOf{}
...
func (o RecordListAllOf) ToMap() (map[string]interface{}, error) {
