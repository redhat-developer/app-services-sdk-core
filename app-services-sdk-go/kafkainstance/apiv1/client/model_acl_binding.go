...
// checks if the AclBinding type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AclBinding{}
...
func (o AclBinding) ToMap() (map[string]interface{}, error) {
