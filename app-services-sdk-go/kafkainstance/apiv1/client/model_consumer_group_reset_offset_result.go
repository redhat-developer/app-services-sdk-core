...
// checks if the ConsumerGroupResetOffsetResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerGroupResetOffsetResult{}
...
func (o ConsumerGroupResetOffsetResult) ToMap() (map[string]interface{}, error) {
