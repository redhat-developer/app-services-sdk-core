...
// checks if the AclBindingListPage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AclBindingListPage{}
...
func (o AclBindingListPage) ToMap() (map[string]interface{}, error) {
