...
// checks if the ConsumerGroupResetOffsetResultItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerGroupResetOffsetResultItem{}
...
func (o ConsumerGroupResetOffsetResultItem) ToMap() (map[string]interface{}, error) {
