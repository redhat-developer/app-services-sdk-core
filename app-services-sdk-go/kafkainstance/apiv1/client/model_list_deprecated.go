...
// checks if the ListDeprecated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListDeprecated{}
...
func (o ListDeprecated) ToMap() (map[string]interface{}, error) {
