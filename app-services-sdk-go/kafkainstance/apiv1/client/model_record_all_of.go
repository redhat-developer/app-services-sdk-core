...
// checks if the RecordAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordAllOf{}
...
func (o RecordAllOf) ToMap() (map[string]interface{}, error) {
	...
	// skip: timestampType is readOnly
	if !IsNil(o.Headers) {
