...
// checks if the AclBindingAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AclBindingAllOf{}
...
func (o AclBindingAllOf) ToMap() (map[string]interface{}, error) {
