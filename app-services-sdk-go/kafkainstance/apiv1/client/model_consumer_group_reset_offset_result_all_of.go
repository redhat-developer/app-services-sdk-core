...
// checks if the ConsumerGroupResetOffsetResultAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerGroupResetOffsetResultAllOf{}
...
func (o ConsumerGroupResetOffsetResultAllOf) ToMap() (map[string]interface{}, error) {
