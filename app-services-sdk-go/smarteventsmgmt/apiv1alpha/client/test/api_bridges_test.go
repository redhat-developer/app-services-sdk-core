...
func Test_smarteventsmgmtclient_BridgesApiService(t *testing.T) {
    ...
    t.Run("Test BridgesApiService BridgesAPIUpdateBridge", func(t *testing.T) {

        t.Skip("skip test")  // remove to run test

        var bridgeId string

        resp, httpRes, err := apiClient.BridgesApi.BridgesAPIUpdateBridge(context.Background(), bridgeId).Execute()
