...
// checks if the CloudRegionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudRegionResponse{}
...
func (o CloudRegionResponse) ToMap() (map[string]interface{}, error) {
