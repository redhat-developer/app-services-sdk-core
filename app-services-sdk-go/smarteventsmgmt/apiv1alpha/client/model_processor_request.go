...
// checks if the ProcessorRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProcessorRequest{}
...
func (o ProcessorRequest) ToMap() (map[string]interface{}, error) {
