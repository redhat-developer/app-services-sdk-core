...
// checks if the ErrorListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorListResponse{}
...
func (o ErrorListResponse) ToMap() (map[string]interface{}, error) {
