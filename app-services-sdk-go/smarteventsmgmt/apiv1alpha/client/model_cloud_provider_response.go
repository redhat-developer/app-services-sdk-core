...
// checks if the CloudProviderResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudProviderResponse{}
...
func (o CloudProviderResponse) ToMap() (map[string]interface{}, error) {
