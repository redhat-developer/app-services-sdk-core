...
// checks if the SourceConnectorListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceConnectorListResponse{}
...
func (o SourceConnectorListResponse) ToMap() (map[string]interface{}, error) {
