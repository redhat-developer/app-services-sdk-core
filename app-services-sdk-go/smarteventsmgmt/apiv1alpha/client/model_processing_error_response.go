...
// checks if the ProcessingErrorResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProcessingErrorResponse{}
...
func (o ProcessingErrorResponse) ToMap() (map[string]interface{}, error) {
