...
// checks if the CloudRegionListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudRegionListResponse{}
...
func (o CloudRegionListResponse) ToMap() (map[string]interface{}, error) {
