...
// checks if the SinkConnectorListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SinkConnectorListResponse{}
...
func (o SinkConnectorListResponse) ToMap() (map[string]interface{}, error) {
