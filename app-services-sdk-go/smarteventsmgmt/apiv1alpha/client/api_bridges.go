...
type BridgesApi interface {
	...
	*/
	BridgesAPIUpdateBridge(ctx context.Context, bridgeId string) ApiBridgesAPIUpdateBridgeRequest

	// BridgesAPIUpdateBridgeExecute executes the request
	//  @return BridgeResponse
	BridgesAPIUpdateBridgeExecute(r ApiBridgesAPIUpdateBridgeRequest) (*BridgeResponse, *http.Response, error)
}
...
func (r ApiBridgesAPIUpdateBridgeRequest) Execute() (*BridgeResponse, *http.Response, error) {
...
Update a Bridge instance for the authenticated user.
 ...
 @return ApiBridgesAPIUpdateBridgeRequest
*/
func (a *BridgesApiService) BridgesAPIUpdateBridge(ctx context.Context, bridgeId string) ApiBridgesAPIUpdateBridgeRequest {
	return ApiBridgesAPIUpdateBridgeRequest{
		ApiService: a,
		ctx: ctx,
		bridgeId: bridgeId,
...
// Execute executes the request
//  @return BridgeResponse
func (a *BridgesApiService) BridgesAPIUpdateBridgeExecute(r ApiBridgesAPIUpdateBridgeRequest) (*BridgeResponse, *http.Response, error) {
	var (
