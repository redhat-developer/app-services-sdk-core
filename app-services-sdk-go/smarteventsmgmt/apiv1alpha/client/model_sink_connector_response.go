...
// checks if the SinkConnectorResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SinkConnectorResponse{}
...
func (o SinkConnectorResponse) ToMap() (map[string]interface{}, error) {
