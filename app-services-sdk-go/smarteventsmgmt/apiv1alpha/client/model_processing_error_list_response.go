...
// checks if the ProcessingErrorListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProcessingErrorListResponse{}
...
func (o ProcessingErrorListResponse) ToMap() (map[string]interface{}, error) {
