...
// checks if the BridgeError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BridgeError{}
...
func (o BridgeError) ToMap() (map[string]interface{}, error) {
