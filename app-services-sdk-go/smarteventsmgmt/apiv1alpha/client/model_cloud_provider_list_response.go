...
// checks if the CloudProviderListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudProviderListResponse{}
...
func (o CloudProviderListResponse) ToMap() (map[string]interface{}, error) {
