...
// checks if the SourceConnectorResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceConnectorResponse{}
...
func (o SourceConnectorResponse) ToMap() (map[string]interface{}, error) {
