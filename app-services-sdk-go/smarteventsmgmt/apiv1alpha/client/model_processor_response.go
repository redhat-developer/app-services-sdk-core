...
// checks if the ProcessorResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProcessorResponse{}
...
func (o ProcessorResponse) ToMap() (map[string]interface{}, error) {
