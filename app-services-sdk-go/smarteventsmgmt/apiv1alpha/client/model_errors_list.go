...
// checks if the ErrorsList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorsList{}
...
func (o ErrorsList) ToMap() (map[string]interface{}, error) {
