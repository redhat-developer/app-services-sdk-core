...
// checks if the BridgeResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BridgeResponse{}
...
func (o BridgeResponse) ToMap() (map[string]interface{}, error) {
