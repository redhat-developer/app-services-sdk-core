...
// checks if the ValidationExceptionData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValidationExceptionData{}
...
func (o ValidationExceptionData) ToMap() (map[string]interface{}, error) {
