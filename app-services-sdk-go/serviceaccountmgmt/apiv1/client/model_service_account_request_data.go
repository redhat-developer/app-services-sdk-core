...
// checks if the ServiceAccountRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceAccountRequestData{}
...
func (o ServiceAccountRequestData) ToMap() (map[string]interface{}, error) {
