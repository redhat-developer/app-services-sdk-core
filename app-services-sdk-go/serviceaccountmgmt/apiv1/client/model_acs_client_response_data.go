...
// checks if the AcsClientResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AcsClientResponseData{}
...
func (o AcsClientResponseData) ToMap() (map[string]interface{}, error) {
