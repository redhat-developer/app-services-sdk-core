...
// checks if the AcsClientRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AcsClientRequestData{}
...
func (o AcsClientRequestData) ToMap() (map[string]interface{}, error) {
