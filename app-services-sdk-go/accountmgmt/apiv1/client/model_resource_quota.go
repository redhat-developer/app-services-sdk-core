...
// checks if the ResourceQuota type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceQuota{}
...
func (o ResourceQuota) ToMap() (map[string]interface{}, error) {
