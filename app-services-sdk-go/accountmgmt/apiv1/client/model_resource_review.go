...
// checks if the ResourceReview type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceReview{}
...
func (o ResourceReview) ToMap() (map[string]interface{}, error) {
