...
// checks if the ResourceReviewRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceReviewRequest{}
...
func (o ResourceReviewRequest) ToMap() (map[string]interface{}, error) {
