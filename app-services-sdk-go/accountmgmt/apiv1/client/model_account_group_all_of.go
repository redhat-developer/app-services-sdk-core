...
// checks if the AccountGroupAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountGroupAllOf{}
...
func (o AccountGroupAllOf) ToMap() (map[string]interface{}, error) {
