...
// checks if the ExportControlReviewRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportControlReviewRequest{}
...
func (o ExportControlReviewRequest) ToMap() (map[string]interface{}, error) {
