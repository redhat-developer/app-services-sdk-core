...
// checks if the ClusterTransferListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterTransferListAllOf{}

// ClusterTransferListAllOf struct for ClusterTransferListAllOf
type ClusterTransferListAllOf struct {
	Items []ClusterTransferListAllOfItemsInner `json:"items,omitempty"`
}
...
// SetItems gets a reference to the given []ClusterTransferListAllOfItemsInner and assigns it to the Items field.
...
func (o ClusterTransferListAllOf) ToMap() (map[string]interface{}, error) {
