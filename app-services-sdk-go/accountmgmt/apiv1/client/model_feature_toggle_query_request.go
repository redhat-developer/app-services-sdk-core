...
// checks if the FeatureToggleQueryRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeatureToggleQueryRequest{}
...
func (o FeatureToggleQueryRequest) ToMap() (map[string]interface{}, error) {
