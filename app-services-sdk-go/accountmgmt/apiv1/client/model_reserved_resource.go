...
// checks if the ReservedResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReservedResource{}
...
func (o ReservedResource) ToMap() (map[string]interface{}, error) {
