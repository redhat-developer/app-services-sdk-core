...
// checks if the SkuListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SkuListAllOf{}
...
func (o SkuListAllOf) ToMap() (map[string]interface{}, error) {
