...
// checks if the ExportControlReview type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportControlReview{}
...
func (o ExportControlReview) ToMap() (map[string]interface{}, error) {
