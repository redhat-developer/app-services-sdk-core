...
// checks if the TermsReviewResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TermsReviewResponse{}
...
func (o TermsReviewResponse) ToMap() (map[string]interface{}, error) {
