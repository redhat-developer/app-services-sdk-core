...
// checks if the AccountGroupAssignmentList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountGroupAssignmentList{}
...
type AccountGroupAssignmentList struct {
	...
	Items []AccountGroupAssignmentListAllOfItemsInner `json:"items"`
}
...
func (o AccountGroupAssignmentList) ToMap() (map[string]interface{}, error) {
