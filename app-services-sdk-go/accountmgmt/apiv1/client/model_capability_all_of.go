...
// checks if the CapabilityAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilityAllOf{}
...
func (o CapabilityAllOf) ToMap() (map[string]interface{}, error) {
