...
// checks if the SubscriptionMetricList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionMetricList{}
...
func (o SubscriptionMetricList) ToMap() (map[string]interface{}, error) {
