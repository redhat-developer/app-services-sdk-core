...
// checks if the SelfResourceReviewRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SelfResourceReviewRequest{}
...
func (o SelfResourceReviewRequest) ToMap() (map[string]interface{}, error) {
