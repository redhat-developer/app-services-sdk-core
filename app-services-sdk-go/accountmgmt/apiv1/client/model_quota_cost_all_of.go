...
// checks if the QuotaCostAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuotaCostAllOf{}
...
func (o QuotaCostAllOf) ToMap() (map[string]interface{}, error) {
