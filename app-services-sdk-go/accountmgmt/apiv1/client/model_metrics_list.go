...
// checks if the MetricsList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricsList{}
...
func (o MetricsList) ToMap() (map[string]interface{}, error) {
