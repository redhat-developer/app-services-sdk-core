...
// checks if the AccessReviewResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessReviewResponse{}
...
func (o AccessReviewResponse) ToMap() (map[string]interface{}, error) {
