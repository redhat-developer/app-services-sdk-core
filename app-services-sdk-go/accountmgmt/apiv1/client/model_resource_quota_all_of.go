...
// checks if the ResourceQuotaAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceQuotaAllOf{}
...
func (o ResourceQuotaAllOf) ToMap() (map[string]interface{}, error) {
