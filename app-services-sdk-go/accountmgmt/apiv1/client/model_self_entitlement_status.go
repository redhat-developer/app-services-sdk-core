...
// checks if the SelfEntitlementStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SelfEntitlementStatus{}
...
func (o SelfEntitlementStatus) ToMap() (map[string]interface{}, error) {
