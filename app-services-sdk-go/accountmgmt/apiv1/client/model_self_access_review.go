...
// checks if the SelfAccessReview type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SelfAccessReview{}
...
func (o SelfAccessReview) ToMap() (map[string]interface{}, error) {
