...
// checks if the DeletedSubscriptionList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeletedSubscriptionList{}
...
func (o DeletedSubscriptionList) ToMap() (map[string]interface{}, error) {
