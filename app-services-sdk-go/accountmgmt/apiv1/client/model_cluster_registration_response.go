...
// checks if the ClusterRegistrationResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterRegistrationResponse{}
...
func (o ClusterRegistrationResponse) ToMap() (map[string]interface{}, error) {
