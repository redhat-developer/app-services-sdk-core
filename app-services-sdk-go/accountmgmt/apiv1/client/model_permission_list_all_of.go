...
// checks if the PermissionListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionListAllOf{}
...
func (o PermissionListAllOf) ToMap() (map[string]interface{}, error) {
