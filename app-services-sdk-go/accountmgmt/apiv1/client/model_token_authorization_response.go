...
// checks if the TokenAuthorizationResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TokenAuthorizationResponse{}
...
func (o TokenAuthorizationResponse) ToMap() (map[string]interface{}, error) {
