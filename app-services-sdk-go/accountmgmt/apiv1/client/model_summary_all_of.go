...
// checks if the SummaryAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SummaryAllOf{}
...
func (o SummaryAllOf) ToMap() (map[string]interface{}, error) {
