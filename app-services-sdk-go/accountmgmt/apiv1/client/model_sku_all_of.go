...
// checks if the SKUAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SKUAllOf{}
...
func (o SKUAllOf) ToMap() (map[string]interface{}, error) {
