...
// checks if the RoleBindingCreateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleBindingCreateRequest{}
...
func (o RoleBindingCreateRequest) ToMap() (map[string]interface{}, error) {
