...
// checks if the TemplateParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateParameter{}
...
func (o TemplateParameter) ToMap() (map[string]interface{}, error) {
