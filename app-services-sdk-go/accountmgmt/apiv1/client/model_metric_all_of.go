...
// checks if the MetricAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricAllOf{}
...
func (o MetricAllOf) ToMap() (map[string]interface{}, error) {
