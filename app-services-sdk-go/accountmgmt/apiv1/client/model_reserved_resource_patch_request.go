...
// checks if the ReservedResourcePatchRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReservedResourcePatchRequest{}
...
func (o ReservedResourcePatchRequest) ToMap() (map[string]interface{}, error) {
