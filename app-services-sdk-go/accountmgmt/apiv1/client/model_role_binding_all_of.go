...
// checks if the RoleBindingAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleBindingAllOf{}
...
func (o RoleBindingAllOf) ToMap() (map[string]interface{}, error) {
