...
// checks if the DeletedSubscription type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeletedSubscription{}
...
func (o DeletedSubscription) ToMap() (map[string]interface{}, error) {
