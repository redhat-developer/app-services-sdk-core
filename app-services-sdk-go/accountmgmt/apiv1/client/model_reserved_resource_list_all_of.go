...
// checks if the ReservedResourceListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReservedResourceListAllOf{}
...
func (o ReservedResourceListAllOf) ToMap() (map[string]interface{}, error) {
