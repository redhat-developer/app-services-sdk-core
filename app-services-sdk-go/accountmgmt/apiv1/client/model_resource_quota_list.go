...
// checks if the ResourceQuotaList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceQuotaList{}
...
func (o ResourceQuotaList) ToMap() (map[string]interface{}, error) {
