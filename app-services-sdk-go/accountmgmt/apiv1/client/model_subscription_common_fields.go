...
// checks if the SubscriptionCommonFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionCommonFields{}
...
func (o SubscriptionCommonFields) ToMap() (map[string]interface{}, error) {
