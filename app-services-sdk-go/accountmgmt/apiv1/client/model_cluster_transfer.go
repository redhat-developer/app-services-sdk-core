...
// checks if the ClusterTransfer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterTransfer{}
...
func (o ClusterTransfer) ToMap() (map[string]interface{}, error) {
