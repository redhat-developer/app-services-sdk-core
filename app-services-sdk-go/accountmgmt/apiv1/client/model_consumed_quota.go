...
// checks if the ConsumedQuota type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumedQuota{}
...
func (o ConsumedQuota) ToMap() (map[string]interface{}, error) {
