...
// checks if the QuotaListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuotaListAllOf{}
...
func (o QuotaListAllOf) ToMap() (map[string]interface{}, error) {
