...
// checks if the AccessTokenCfg type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessTokenCfg{}
...
func (o AccessTokenCfg) ToMap() (map[string]interface{}, error) {
