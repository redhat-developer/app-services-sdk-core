...
// checks if the SkuRulesList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SkuRulesList{}
...
func (o SkuRulesList) ToMap() (map[string]interface{}, error) {
