...
// checks if the CapabilityReview type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilityReview{}
...
func (o CapabilityReview) ToMap() (map[string]interface{}, error) {
