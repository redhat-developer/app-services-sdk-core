...
// checks if the SelfTermsReview type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SelfTermsReview{}
...
func (o SelfTermsReview) ToMap() (map[string]interface{}, error) {
