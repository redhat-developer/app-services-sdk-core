...
// checks if the CapabilityReviewRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilityReviewRequest{}
...
func (o CapabilityReviewRequest) ToMap() (map[string]interface{}, error) {
