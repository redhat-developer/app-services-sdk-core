...
// checks if the SubscriptionRoleBindingList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionRoleBindingList{}
...
func (o SubscriptionRoleBindingList) ToMap() (map[string]interface{}, error) {
