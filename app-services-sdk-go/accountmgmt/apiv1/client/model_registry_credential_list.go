...
// checks if the RegistryCredentialList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegistryCredentialList{}
...
func (o RegistryCredentialList) ToMap() (map[string]interface{}, error) {
