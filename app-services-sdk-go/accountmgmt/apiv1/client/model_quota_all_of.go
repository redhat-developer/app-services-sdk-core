...
// checks if the QuotaAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuotaAllOf{}
...
func (o QuotaAllOf) ToMap() (map[string]interface{}, error) {
