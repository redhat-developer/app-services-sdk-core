...
// checks if the OneMetric type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OneMetric{}
...
func (o OneMetric) ToMap() (map[string]interface{}, error) {
