...
// checks if the SelfResourceReview type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SelfResourceReview{}
...
func (o SelfResourceReview) ToMap() (map[string]interface{}, error) {
