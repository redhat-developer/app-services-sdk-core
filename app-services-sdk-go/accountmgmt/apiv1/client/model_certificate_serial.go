...
// checks if the CertificateSerial type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CertificateSerial{}
...
func (o CertificateSerial) ToMap() (map[string]interface{}, error) {
