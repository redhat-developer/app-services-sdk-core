...
// checks if the QuotaCostList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuotaCostList{}
...
func (o QuotaCostList) ToMap() (map[string]interface{}, error) {
