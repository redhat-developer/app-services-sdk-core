...
// checks if the ConsumedQuotaAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumedQuotaAllOf{}
...
func (o ConsumedQuotaAllOf) ToMap() (map[string]interface{}, error) {
