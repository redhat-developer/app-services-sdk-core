...
// checks if the CloudResourceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudResourceList{}
...
func (o CloudResourceList) ToMap() (map[string]interface{}, error) {
