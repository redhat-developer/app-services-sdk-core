...
// checks if the PermissionAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionAllOf{}
...
func (o PermissionAllOf) ToMap() (map[string]interface{}, error) {
