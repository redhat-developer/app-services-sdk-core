...
// checks if the SubscriptionRoleBindingAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionRoleBindingAllOf{}
...
func (o SubscriptionRoleBindingAllOf) ToMap() (map[string]interface{}, error) {
