...
// checks if the SupportCasesCreatedResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportCasesCreatedResponse{}
...
func (o SupportCasesCreatedResponse) ToMap() (map[string]interface{}, error) {
