...
// checks if the SelfServiceLandingPageSchemaConfigTryLearn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SelfServiceLandingPageSchemaConfigTryLearn{}
...
func (o SelfServiceLandingPageSchemaConfigTryLearn) ToMap() (map[string]interface{}, error) {
