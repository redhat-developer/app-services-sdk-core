...
// checks if the SkuRulesListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SkuRulesListAllOf{}
...
func (o SkuRulesListAllOf) ToMap() (map[string]interface{}, error) {
