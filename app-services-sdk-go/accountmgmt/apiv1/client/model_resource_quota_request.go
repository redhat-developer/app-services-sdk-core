...
// checks if the ResourceQuotaRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceQuotaRequest{}
...
func (o ResourceQuotaRequest) ToMap() (map[string]interface{}, error) {
