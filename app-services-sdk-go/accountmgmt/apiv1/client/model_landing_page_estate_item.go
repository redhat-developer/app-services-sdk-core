...
// checks if the LandingPageEstateItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LandingPageEstateItem{}
...
func (o LandingPageEstateItem) ToMap() (map[string]interface{}, error) {
