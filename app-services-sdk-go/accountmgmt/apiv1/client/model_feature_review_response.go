...
// checks if the FeatureReviewResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeatureReviewResponse{}
...
func (o FeatureReviewResponse) ToMap() (map[string]interface{}, error) {
