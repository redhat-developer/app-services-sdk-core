...
// checks if the LabelList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LabelList{}
...
func (o LabelList) ToMap() (map[string]interface{}, error) {
