...
// checks if the CloudResourceAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudResourceAllOf{}
...
func (o CloudResourceAllOf) ToMap() (map[string]interface{}, error) {
