...
// checks if the SubscriptionCommonFieldsAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionCommonFieldsAllOf{}
...
func (o SubscriptionCommonFieldsAllOf) ToMap() (map[string]interface{}, error) {
