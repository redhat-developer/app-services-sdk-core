...
// checks if the TokenAuthorizationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TokenAuthorizationRequest{}
...
func (o TokenAuthorizationRequest) ToMap() (map[string]interface{}, error) {
