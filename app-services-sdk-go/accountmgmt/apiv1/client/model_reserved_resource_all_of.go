...
// checks if the ReservedResourceAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReservedResourceAllOf{}
...
func (o ReservedResourceAllOf) ToMap() (map[string]interface{}, error) {
