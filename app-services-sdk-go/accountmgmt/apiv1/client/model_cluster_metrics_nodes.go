...
// checks if the ClusterMetricsNodes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterMetricsNodes{}
...
func (o ClusterMetricsNodes) ToMap() (map[string]interface{}, error) {
