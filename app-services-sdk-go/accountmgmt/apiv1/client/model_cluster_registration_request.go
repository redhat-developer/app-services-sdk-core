...
// checks if the ClusterRegistrationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterRegistrationRequest{}
...
func (o ClusterRegistrationRequest) ToMap() (map[string]interface{}, error) {
