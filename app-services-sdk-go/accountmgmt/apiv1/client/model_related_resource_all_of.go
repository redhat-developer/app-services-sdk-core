...
// checks if the RelatedResourceAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RelatedResourceAllOf{}
...
func (o RelatedResourceAllOf) ToMap() (map[string]interface{}, error) {
