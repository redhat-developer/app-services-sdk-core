...
// checks if the AccountGroupAssignmentAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountGroupAssignmentAllOf{}
...
func (o AccountGroupAssignmentAllOf) ToMap() (map[string]interface{}, error) {
