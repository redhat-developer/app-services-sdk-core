...
// checks if the ClusterAuthorizationResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterAuthorizationResponse{}
...
func (o ClusterAuthorizationResponse) ToMap() (map[string]interface{}, error) {
