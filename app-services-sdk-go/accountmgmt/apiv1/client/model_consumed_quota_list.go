...
// checks if the ConsumedQuotaList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumedQuotaList{}
...
func (o ConsumedQuotaList) ToMap() (map[string]interface{}, error) {
