...
// checks if the LabelAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LabelAllOf{}
...
func (o LabelAllOf) ToMap() (map[string]interface{}, error) {
