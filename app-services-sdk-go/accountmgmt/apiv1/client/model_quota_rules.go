...
// checks if the QuotaRules type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuotaRules{}
...
func (o QuotaRules) ToMap() (map[string]interface{}, error) {
