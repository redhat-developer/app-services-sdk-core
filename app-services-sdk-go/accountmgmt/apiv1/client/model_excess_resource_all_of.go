...
// checks if the ExcessResourceAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExcessResourceAllOf{}
...
func (o ExcessResourceAllOf) ToMap() (map[string]interface{}, error) {
