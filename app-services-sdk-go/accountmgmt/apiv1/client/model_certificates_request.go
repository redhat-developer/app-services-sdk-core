...
// checks if the CertificatesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CertificatesRequest{}
...
func (o CertificatesRequest) ToMap() (map[string]interface{}, error) {
