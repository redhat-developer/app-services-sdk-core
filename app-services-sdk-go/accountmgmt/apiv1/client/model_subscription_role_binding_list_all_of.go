...
// checks if the SubscriptionRoleBindingListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionRoleBindingListAllOf{}
...
func (o SubscriptionRoleBindingListAllOf) ToMap() (map[string]interface{}, error) {
