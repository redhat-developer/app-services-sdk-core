...
// checks if the AccountGroupListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountGroupListAllOf{}

// AccountGroupListAllOf struct for AccountGroupListAllOf
type AccountGroupListAllOf struct {
	Items []AccountGroupListAllOfItemsInner `json:"items,omitempty"`
}
...
// SetItems gets a reference to the given []AccountGroupListAllOfItemsInner and assigns it to the Items field.
...
func (o AccountGroupListAllOf) ToMap() (map[string]interface{}, error) {
