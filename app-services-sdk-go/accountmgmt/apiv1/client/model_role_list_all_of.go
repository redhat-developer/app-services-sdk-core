...
// checks if the RoleListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleListAllOf{}
...
func (o RoleListAllOf) ToMap() (map[string]interface{}, error) {
