...
// checks if the RoleBindingListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleBindingListAllOf{}
...
func (o RoleBindingListAllOf) ToMap() (map[string]interface{}, error) {
