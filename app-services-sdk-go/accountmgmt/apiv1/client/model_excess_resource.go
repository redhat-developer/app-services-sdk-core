...
// checks if the ExcessResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExcessResource{}
...
func (o ExcessResource) ToMap() (map[string]interface{}, error) {
