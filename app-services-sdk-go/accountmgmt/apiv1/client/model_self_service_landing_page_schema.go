...
// checks if the SelfServiceLandingPageSchema type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SelfServiceLandingPageSchema{}
...
func (o SelfServiceLandingPageSchema) ToMap() (map[string]interface{}, error) {
