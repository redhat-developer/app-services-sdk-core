...
// checks if the SummaryMetricsAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SummaryMetricsAllOf{}
...
func (o SummaryMetricsAllOf) ToMap() (map[string]interface{}, error) {
