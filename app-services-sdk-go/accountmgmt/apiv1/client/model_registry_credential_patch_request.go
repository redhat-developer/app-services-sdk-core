...
// checks if the RegistryCredentialPatchRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegistryCredentialPatchRequest{}
...
func (o RegistryCredentialPatchRequest) ToMap() (map[string]interface{}, error) {
