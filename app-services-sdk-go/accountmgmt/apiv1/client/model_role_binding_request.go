...
// checks if the RoleBindingRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoleBindingRequest{}
...
func (o RoleBindingRequest) ToMap() (map[string]interface{}, error) {
