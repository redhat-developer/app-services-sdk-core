...
// checks if the ConnectorNamespaceEvalRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorNamespaceEvalRequest{}
...
func (o ConnectorNamespaceEvalRequest) ToMap() (map[string]interface{}, error) {
