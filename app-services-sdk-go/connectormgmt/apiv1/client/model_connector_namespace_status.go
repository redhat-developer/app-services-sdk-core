...
// checks if the ConnectorNamespaceStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorNamespaceStatus{}
...
func (o ConnectorNamespaceStatus) ToMap() (map[string]interface{}, error) {
