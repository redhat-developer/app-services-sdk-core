...
// checks if the ConnectorClusterRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorClusterRequest{}
...
func (o ConnectorClusterRequest) ToMap() (map[string]interface{}, error) {
