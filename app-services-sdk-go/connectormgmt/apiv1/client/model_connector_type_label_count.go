...
// checks if the ConnectorTypeLabelCount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorTypeLabelCount{}
...
func (o ConnectorTypeLabelCount) ToMap() (map[string]interface{}, error) {
