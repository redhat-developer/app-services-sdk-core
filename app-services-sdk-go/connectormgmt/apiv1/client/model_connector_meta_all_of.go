...
// checks if the ConnectorMetaAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorMetaAllOf{}
...
func (o ConnectorMetaAllOf) ToMap() (map[string]interface{}, error) {
