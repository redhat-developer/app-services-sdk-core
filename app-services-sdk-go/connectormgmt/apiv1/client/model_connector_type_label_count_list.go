...
// checks if the ConnectorTypeLabelCountList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorTypeLabelCountList{}
...
func (o ConnectorTypeLabelCountList) ToMap() (map[string]interface{}, error) {
