...
// checks if the ConnectorRequestMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorRequestMeta{}
...
func (o ConnectorRequestMeta) ToMap() (map[string]interface{}, error) {
