...
// checks if the ServiceConnectionSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceConnectionSettings{}
...
func (o ServiceConnectionSettings) ToMap() (map[string]interface{}, error) {
