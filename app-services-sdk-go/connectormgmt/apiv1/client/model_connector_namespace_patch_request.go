...
// checks if the ConnectorNamespacePatchRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorNamespacePatchRequest{}
...
func (o ConnectorNamespacePatchRequest) ToMap() (map[string]interface{}, error) {
