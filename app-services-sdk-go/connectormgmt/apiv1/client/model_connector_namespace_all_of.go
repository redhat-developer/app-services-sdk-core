...
// checks if the ConnectorNamespaceAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorNamespaceAllOf{}
...
func (o ConnectorNamespaceAllOf) ToMap() (map[string]interface{}, error) {
