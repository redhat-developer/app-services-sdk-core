...
// checks if the ConnectorTypeList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorTypeList{}
...
func (o ConnectorTypeList) ToMap() (map[string]interface{}, error) {
