...
// checks if the ConnectorNamespaceTenant type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorNamespaceTenant{}
...
func (o ConnectorNamespaceTenant) ToMap() (map[string]interface{}, error) {
