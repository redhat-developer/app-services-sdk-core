...
// checks if the ConnectorCluster type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorCluster{}
...
func (o ConnectorCluster) ToMap() (map[string]interface{}, error) {
