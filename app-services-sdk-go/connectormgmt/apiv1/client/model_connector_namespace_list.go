...
// checks if the ConnectorNamespaceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorNamespaceList{}
...
func (o ConnectorNamespaceList) ToMap() (map[string]interface{}, error) {
