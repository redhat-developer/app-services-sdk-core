...
// checks if the ConnectorClusterMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorClusterMeta{}
...
func (o ConnectorClusterMeta) ToMap() (map[string]interface{}, error) {
