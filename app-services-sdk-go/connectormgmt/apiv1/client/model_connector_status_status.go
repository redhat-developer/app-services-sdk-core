...
// checks if the ConnectorStatusStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorStatusStatus{}
...
func (o ConnectorStatusStatus) ToMap() (map[string]interface{}, error) {
