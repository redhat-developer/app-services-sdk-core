...
// checks if the ConnectorClusterStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorClusterStatus{}
...
func (o ConnectorClusterStatus) ToMap() (map[string]interface{}, error) {
