...
// checks if the ConnectorNamespaceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorNamespaceRequest{}
...
func (o ConnectorNamespaceRequest) ToMap() (map[string]interface{}, error) {
