...
// checks if the ObjectMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectMeta{}
...
func (o ObjectMeta) ToMap() (map[string]interface{}, error) {
