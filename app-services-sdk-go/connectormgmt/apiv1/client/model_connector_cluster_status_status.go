...
// checks if the ConnectorClusterStatusStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorClusterStatusStatus{}
...
func (o ConnectorClusterStatusStatus) ToMap() (map[string]interface{}, error) {
