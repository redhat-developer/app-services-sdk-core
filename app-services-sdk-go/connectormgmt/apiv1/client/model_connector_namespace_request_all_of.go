...
// checks if the ConnectorNamespaceRequestAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorNamespaceRequestAllOf{}
...
func (o ConnectorNamespaceRequestAllOf) ToMap() (map[string]interface{}, error) {
