...
// checks if the ConnectorNamespaceMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorNamespaceMeta{}
...
func (o ConnectorNamespaceMeta) ToMap() (map[string]interface{}, error) {
