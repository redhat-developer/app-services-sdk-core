...
// checks if the SchemaRegistryConnectionSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SchemaRegistryConnectionSettings{}
...
func (o SchemaRegistryConnectionSettings) ToMap() (map[string]interface{}, error) {
