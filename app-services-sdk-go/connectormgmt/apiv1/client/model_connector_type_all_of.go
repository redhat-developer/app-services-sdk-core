...
// checks if the ConnectorTypeAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorTypeAllOf{}
...
func (o ConnectorTypeAllOf) ToMap() (map[string]interface{}, error) {
