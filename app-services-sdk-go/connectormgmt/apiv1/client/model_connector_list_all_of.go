...
// checks if the ConnectorListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorListAllOf{}
...
func (o ConnectorListAllOf) ToMap() (map[string]interface{}, error) {
