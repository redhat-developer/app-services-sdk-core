...
// checks if the ConnectorClusterRequestMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorClusterRequestMeta{}
...
func (o ConnectorClusterRequestMeta) ToMap() (map[string]interface{}, error) {
