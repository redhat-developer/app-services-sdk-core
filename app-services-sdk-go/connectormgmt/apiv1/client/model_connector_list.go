...
// checks if the ConnectorList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorList{}
...
func (o ConnectorList) ToMap() (map[string]interface{}, error) {
