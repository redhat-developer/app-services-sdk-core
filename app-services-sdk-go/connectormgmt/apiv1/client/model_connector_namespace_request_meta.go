...
// checks if the ConnectorNamespaceRequestMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorNamespaceRequestMeta{}
...
func (o ConnectorNamespaceRequestMeta) ToMap() (map[string]interface{}, error) {
