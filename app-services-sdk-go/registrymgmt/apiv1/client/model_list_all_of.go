...
// checks if the ListAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListAllOf{}
...
func (o ListAllOf) ToMap() (map[string]interface{}, error) {
