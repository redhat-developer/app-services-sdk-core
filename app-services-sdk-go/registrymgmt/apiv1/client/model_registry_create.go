...
// checks if the RegistryCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegistryCreate{}
...
func (o RegistryCreate) ToMap() (map[string]interface{}, error) {
