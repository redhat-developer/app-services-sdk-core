...
// checks if the RegistryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegistryList{}
...
func (o RegistryList) ToMap() (map[string]interface{}, error) {
