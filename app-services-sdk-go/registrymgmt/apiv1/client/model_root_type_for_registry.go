...
// checks if the RootTypeForRegistry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RootTypeForRegistry{}
...
func (o RootTypeForRegistry) ToMap() (map[string]interface{}, error) {
