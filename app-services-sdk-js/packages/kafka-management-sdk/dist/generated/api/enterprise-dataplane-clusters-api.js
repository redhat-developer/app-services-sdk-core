...
const EnterpriseDataplaneClustersApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getEnterpriseClusterWithAddonParameters: (id, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getEnterpriseClusterWithAddonParameters', 'id', id);
...
const EnterpriseDataplaneClustersApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getEnterpriseClusterWithAddonParameters(id, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getEnterpriseClusterWithAddonParameters(id, options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
...
class EnterpriseDataplaneClustersApi extends base_1.BaseAPI {
     ...
     */
    getEnterpriseClusterWithAddonParameters(id, options) {
        return (0, exports.EnterpriseDataplaneClustersApiFp)(this.configuration).getEnterpriseClusterWithAddonParameters(id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * List all Enterprise data plane clusters
     * @param {*} [options] Override http request option.
