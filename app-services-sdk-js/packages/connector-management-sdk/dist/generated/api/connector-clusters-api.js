...
const ConnectorClustersApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listConnectorClusters: (page, size, orderBy, search, options = {}) => __awaiter(this, void 0, void 0, function* () {
            const localVarPath = `/api/connector_mgmt/v1/kafka_connector_clusters`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            let baseOptions;
...
const ConnectorClustersApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listConnectorClusters(page, size, orderBy, search, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.listConnectorClusters(page, size, orderBy, search, options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
...
class ConnectorClustersApi extends base_1.BaseAPI {
     ...
     */
    listConnectorClusters(page, size, orderBy, search, options) {
        return (0, exports.ConnectorClustersApiFp)(this.configuration).listConnectorClusters(page, size, orderBy, search, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * udpate a connector cluster
     * @summary udpate a connector cluster
