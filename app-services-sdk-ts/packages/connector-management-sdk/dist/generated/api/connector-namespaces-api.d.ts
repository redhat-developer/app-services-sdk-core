 ...
 * @export
 */
export declare const ConnectorNamespacesApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     */
    createEvaluationNamespace: (connectorNamespaceEvalRequest: ConnectorNamespaceEvalRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getConnectorNamespace: (connectorNamespaceId: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listConnectorNamespaces: (page?: string, size?: string, orderBy?: string, search?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * ConnectorNamespacesApi - functional programming interface
 * @export
 */
export declare const ConnectorNamespacesApiFp: (configuration?: Configuration) => {
    /**
     * Create a new evaluation connector namespace
     * @summary Create a new short lived evaluation connector namespace
     * @param {ConnectorNamespaceEvalRequest} connectorNamespaceEvalRequest Connector namespace data
     ...
     * @throws {RequiredError}
     */
    createEvaluationNamespace(connectorNamespaceEvalRequest: ConnectorNamespaceEvalRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ConnectorNamespace>>;
    /**
     * Get a connector namespace
     * @summary Get a connector namespace
     * @param {string} connectorNamespaceId The id of the connector namespace
     ...
     * @throws {RequiredError}
     */
    getConnectorNamespace(connectorNamespaceId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ConnectorNamespace>>;
    /**
     * Returns a list of connector namespaces
     * @summary Returns a list of connector namespaces
     * @param {string} [page] Page index
     ...
     * @throws {RequiredError}
     */
    listConnectorNamespaces(page?: string, size?: string, orderBy?: string, search?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ConnectorNamespaceList>>;
};
/**
 * ConnectorNamespacesApi - factory interface
 * @export
 */
export declare const ConnectorNamespacesApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Create a new evaluation connector namespace
     * @summary Create a new short lived evaluation connector namespace
     * @param {ConnectorNamespaceEvalRequest} connectorNamespaceEvalRequest Connector namespace data
 ...
 * @extends {BaseAPI}
 */
export declare class ConnectorNamespacesApi extends BaseAPI implements ConnectorNamespacesApiInterface {
    /**
     * Create a new evaluation connector namespace
     * @summary Create a new short lived evaluation connector namespace
     * @param {ConnectorNamespaceEvalRequest} connectorNamespaceEvalRequest Connector namespace data
     ...
     */
    createEvaluationNamespace(connectorNamespaceEvalRequest: ConnectorNamespaceEvalRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ConnectorNamespace, any>>;
    /**
     * Get a connector namespace
     * @summary Get a connector namespace
     * @param {string} connectorNamespaceId The id of the connector namespace
     ...
     * @memberof ConnectorNamespacesApi
     */
    getConnectorNamespace(connectorNamespaceId: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ConnectorNamespace, any>>;
    /**
     * Returns a list of connector namespaces
     * @summary Returns a list of connector namespaces
     * @param {string} [page] Page index
     ...
     * @memberof ConnectorNamespacesApi
     */
    listConnectorNamespaces(page?: string, size?: string, orderBy?: string, search?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ConnectorNamespaceList, any>>;
}
