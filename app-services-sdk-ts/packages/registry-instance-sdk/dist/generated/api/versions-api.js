...
const VersionsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        addArtifactVersionComment: (groupId, artifactId, version, newComment, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupId' is not null or undefined
            (0, common_1.assertParamExists)('addArtifactVersionComment', 'groupId', groupId);
            // verify required parameter 'artifactId' is not null or undefined
            (0, common_1.assertParamExists)('addArtifactVersionComment', 'artifactId', artifactId);
            // verify required parameter 'version' is not null or undefined
            (0, common_1.assertParamExists)('addArtifactVersionComment', 'version', version);
            // verify required parameter 'newComment' is not null or undefined
            (0, common_1.assertParamExists)('addArtifactVersionComment', 'newComment', newComment);
            ...
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(newComment, localVarRequestOptions, configuration);
            return {
         ...
         * @throws {RequiredError}
         */
        deleteArtifactVersionComment: (groupId, artifactId, version, commentId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupId' is not null or undefined
            (0, common_1.assertParamExists)('deleteArtifactVersionComment', 'groupId', groupId);
            // verify required parameter 'artifactId' is not null or undefined
            (0, common_1.assertParamExists)('deleteArtifactVersionComment', 'artifactId', artifactId);
            // verify required parameter 'version' is not null or undefined
            (0, common_1.assertParamExists)('deleteArtifactVersionComment', 'version', version);
            // verify required parameter 'commentId' is not null or undefined
            (0, common_1.assertParamExists)('deleteArtifactVersionComment', 'commentId', commentId);
         ...
         * @throws {RequiredError}
         */
        getArtifactVersionComments: (groupId, artifactId, version, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupId' is not null or undefined
            (0, common_1.assertParamExists)('getArtifactVersionComments', 'groupId', groupId);
            // verify required parameter 'artifactId' is not null or undefined
            (0, common_1.assertParamExists)('getArtifactVersionComments', 'artifactId', artifactId);
            // verify required parameter 'version' is not null or undefined
            (0, common_1.assertParamExists)('getArtifactVersionComments', 'version', version);
            const localVarPath = `/groups/{groupId}/artifacts/{artifactId}/versions/{version}/comments`
                .replace(`{${"groupId"}}`, encodeURIComponent(String(groupId)))
                .replace(`{${"artifactId"}}`, encodeURIComponent(String(artifactId)))
                .replace(`{${"version"}}`, encodeURIComponent(String(version)));
         ...
         * @throws {RequiredError}
         */
        getArtifactVersionReferences: (groupId, artifactId, version, refType, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateArtifactVersionComment: (groupId, artifactId, version, commentId, newComment, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'groupId' is not null or undefined
            (0, common_1.assertParamExists)('updateArtifactVersionComment', 'groupId', groupId);
            // verify required parameter 'artifactId' is not null or undefined
            (0, common_1.assertParamExists)('updateArtifactVersionComment', 'artifactId', artifactId);
            // verify required parameter 'version' is not null or undefined
            (0, common_1.assertParamExists)('updateArtifactVersionComment', 'version', version);
            // verify required parameter 'commentId' is not null or undefined
            (0, common_1.assertParamExists)('updateArtifactVersionComment', 'commentId', commentId);
            // verify required parameter 'newComment' is not null or undefined
            (0, common_1.assertParamExists)('updateArtifactVersionComment', 'newComment', newComment);
            const localVarPath = `/groups/{groupId}/artifacts/{artifactId}/versions/{version}/comments/{commentId}`
                .replace(`{${"groupId"}}`, encodeURIComponent(String(groupId)))
                .replace(`{${"artifactId"}}`, encodeURIComponent(String(artifactId)))
                .replace(`{${"version"}}`, encodeURIComponent(String(version)))
...
const VersionsApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        addArtifactVersionComment(groupId, artifactId, version, newComment, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.addArtifactVersionComment(groupId, artifactId, version, newComment, options);
         ...
         * @throws {RequiredError}
         */
        deleteArtifactVersionComment(groupId, artifactId, version, commentId, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.deleteArtifactVersionComment(groupId, artifactId, version, commentId, options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        getArtifactVersionComments(groupId, artifactId, version, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getArtifactVersionComments(groupId, artifactId, version, options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        getArtifactVersionReferences(groupId, artifactId, version, refType, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getArtifactVersionReferences(groupId, artifactId, version, refType, options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        updateArtifactVersionComment(groupId, artifactId, version, commentId, newComment, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.updateArtifactVersionComment(groupId, artifactId, version, commentId, newComment, options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
            });
        },
        /**
...
class VersionsApi extends base_1.BaseAPI {
     ...
     */
    addArtifactVersionComment(groupId, artifactId, version, newComment, options) {
        return (0, exports.VersionsApiFp)(this.configuration).addArtifactVersionComment(groupId, artifactId, version, newComment, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Creates a new version of the artifact by uploading new content.  The configured rules for the artifact are applied, and if they all pass, the new content is added as the most recent  version of the artifact.  If any of the rules fail, an error is returned.  The body of the request can be the raw content of the new artifact version, or the raw content  and a set of references pointing to other artifacts, and the type of that content should match the artifact\'s type (for example if the artifact type is `AVRO` then the content of the request should be an Apache Avro document).  This operation can fail for the following reasons:  * Provided content (request body) was empty (HTTP error `400`) * No artifact with this `artifactId` exists (HTTP error `404`) * The new content violates one of the rules configured for the artifact (HTTP error `409`) * A server error occurred (HTTP error `500`)
     * @summary Create artifact version
     ...
     */
    deleteArtifactVersionComment(groupId, artifactId, version, commentId, options) {
        return (0, exports.VersionsApiFp)(this.configuration).deleteArtifactVersionComment(groupId, artifactId, version, commentId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves a single version of the artifact content.  Both the `artifactId` and the unique `version` number must be provided.  The `Content-Type` of the response depends  on the artifact type.  In most cases, this is `application/json`, but for some types  it may be different (for example, `PROTOBUF`).  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No version with this `version` exists (HTTP error `404`) * A server error occurred (HTTP error `500`)
     * @summary Get artifact version
     ...
     */
    getArtifactVersionComments(groupId, artifactId, version, options) {
        return (0, exports.VersionsApiFp)(this.configuration).getArtifactVersionComments(groupId, artifactId, version, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Retrieves all references for a single version of an artifact.  Both the `artifactId` and the unique `version` number must be provided.  Using the `refType` query parameter, it is possible to retrieve an array of either the inbound or outbound references.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No version with this `version` exists (HTTP error `404`) * A server error occurred (HTTP error `500`)
     * @summary Get artifact version references
     ...
     */
    getArtifactVersionReferences(groupId, artifactId, version, refType, options) {
        return (0, exports.VersionsApiFp)(this.configuration).getArtifactVersionReferences(groupId, artifactId, version, refType, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns a list of all versions of the artifact.  The result set is paged.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * A server error occurred (HTTP error `500`)
     * @summary List artifact versions
     ...
     */
    updateArtifactVersionComment(groupId, artifactId, version, commentId, newComment, options) {
        return (0, exports.VersionsApiFp)(this.configuration).updateArtifactVersionComment(groupId, artifactId, version, commentId, newComment, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Updates the state of a specific version of an artifact.  For example, you can use  this operation to disable a specific version.  This operation can fail for the following reasons:  * No artifact with this `artifactId` exists (HTTP error `404`) * No version with this `version` exists (HTTP error `404`) * A server error occurred (HTTP error `500`)
     * @summary Update artifact version state
