...
export declare const ClusterAuthorizationRequestProductCategoryEnum: {
    readonly AssistedInstall: "assistedInstall";
};
...
export declare const ClusterAuthorizationRequestProductIdEnum: {
    readonly Ocp: "ocp";
    readonly Osd: "osd";
    readonly Osdtrial: "osdtrial";
    readonly Moa: "moa";
    readonly Rhmi: "rhmi";
};
