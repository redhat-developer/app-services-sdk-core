package com.openshift.cloud.api.registry.instance.ids.globalids.item;
...
import com.openshift.cloud.api.registry.instance.ids.globalids.item.references.ReferencesRequestBuilder;
 ...
 */
public class WithGlobalItemRequestBuilder {
    ...
    public WithGlobalItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        Objects.requireNonNull(pathParameters);
        Objects.requireNonNull(requestAdapter);
        this.urlTemplate = "{+baseurl}/ids/globalIds/{globalId}{?dereference*}";
     ...
     */
    @javax.annotation.Nullable
    public WithGlobalItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/ids/globalIds/{globalId}{?dereference*}";
