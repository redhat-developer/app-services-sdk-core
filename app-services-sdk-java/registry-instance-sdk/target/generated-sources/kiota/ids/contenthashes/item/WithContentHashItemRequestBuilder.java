package com.openshift.cloud.api.registry.instance.ids.contenthashes.item;
...
import com.openshift.cloud.api.registry.instance.ids.contenthashes.item.references.ReferencesRequestBuilder;
...
public class WithContentHashItemRequestBuilder {
    ...
    public WithContentHashItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        Objects.requireNonNull(pathParameters);
        Objects.requireNonNull(requestAdapter);
        this.urlTemplate = "{+baseurl}/ids/contentHashes/{contentHash}";
     ...
     */
    @javax.annotation.Nullable
    public WithContentHashItemRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/ids/contentHashes/{contentHash}";
