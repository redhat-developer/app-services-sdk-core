package com.openshift.cloud.api.registry.instance.admin.importEscaped;
...
public class ImportRequestBuilder {
    ...
    public ImportRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/admin/import";
    ...
    public java.util.concurrent.CompletableFuture<Void> post(@javax.annotation.Nonnull final InputStream body) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Void> post(@javax.annotation.Nonnull final InputStream body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
