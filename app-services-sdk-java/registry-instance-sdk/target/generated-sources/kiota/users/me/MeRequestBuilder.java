package com.openshift.cloud.api.registry.instance.users.me;
...
public class MeRequestBuilder {
    ...
    public java.util.concurrent.CompletableFuture<UserInfo> get() {
        try {
            ...
            final java.util.concurrent.CompletableFuture<UserInfo> executionException = new java.util.concurrent.CompletableFuture<UserInfo>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<UserInfo> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
