...
public class ResourceReview implements AdditionalDataHolder, Parsable {
    /** The account_username property */
    private String accountUsername;
    /** The action property */
    private ResourceReview_action action;
    ...
    private ResourceReview_resource_type resourceType;
     ...
     * @return a ResourceReview
     */
    @javax.annotation.Nonnull
    public static ResourceReview createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
     ...
     * @return a ResourceReview_action
     */
    @javax.annotation.Nullable
    public ResourceReview_action getAction() {
        return this.action;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("action", (n) -> { this.setAction(n.getEnumValue(ResourceReview_action.class)); });
        ...
        deserializerMap.put("resource_type", (n) -> { this.setResourceType(n.getEnumValue(ResourceReview_resource_type.class)); });
     ...
     * @return a ResourceReview_resource_type
     */
    @javax.annotation.Nullable
    public ResourceReview_resource_type getResourceType() {
     ...
     */
    @javax.annotation.Nonnull
    public void setAction(@javax.annotation.Nullable final ResourceReview_action value) {
        this.action = value;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setResourceType(@javax.annotation.Nullable final ResourceReview_resource_type value) {
