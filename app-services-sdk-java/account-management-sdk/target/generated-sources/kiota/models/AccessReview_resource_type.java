...
public enum AccessReview_resource_type implements ValuedEnum {
    AddOn("AddOn"),
    Flavour("Flavour"),
    Account("Account"),
    ...
    AccessReview_resource_type(final String value) {
        this.value = value;
    }
    @javax.annotation.Nonnull
    public String getValue() { return this.value; }
    @javax.annotation.Nullable
    public static AccessReview_resource_type forValue(@javax.annotation.Nonnull final String searchValue) {
