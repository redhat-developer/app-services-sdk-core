...
public enum AccessReviewResponse_resource_type implements ValuedEnum {
    AddOn("AddOn"),
    Flavour("Flavour"),
    Account("Account"),
    ...
    AccessReviewResponse_resource_type(final String value) {
        this.value = value;
    }
    @javax.annotation.Nonnull
    public String getValue() { return this.value; }
    @javax.annotation.Nullable
    public static AccessReviewResponse_resource_type forValue(@javax.annotation.Nonnull final String searchValue) {
