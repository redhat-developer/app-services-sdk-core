...
public enum ExcessResource_billing_model implements ValuedEnum {
    Standard("standard"),
    ...
    ExcessResource_billing_model(final String value) {
        this.value = value;
    }
    @javax.annotation.Nonnull
    public String getValue() { return this.value; }
    @javax.annotation.Nullable
    public static ExcessResource_billing_model forValue(@javax.annotation.Nonnull final String searchValue) {
