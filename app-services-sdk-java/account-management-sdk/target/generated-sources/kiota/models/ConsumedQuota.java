...
public class ConsumedQuota extends ObjectReference implements Parsable {
    /** The availability_zone_type property */
    private String availabilityZoneType;
    /** The billing_model property */
    private ConsumedQuota_billing_model billingModel;
    /** The byoc property */
    ...
    /**
     * Instantiates a new ConsumedQuota and sets the default values.
     * @return a void
     */
     ...
     * @return a ConsumedQuota
     */
    @javax.annotation.Nonnull
    public static ConsumedQuota createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ConsumedQuota();
    }
    /**
     ...
     * @return a ConsumedQuota_billing_model
     */
    @javax.annotation.Nullable
    public ConsumedQuota_billing_model getBillingModel() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("billing_model", (n) -> { this.setBillingModel(n.getEnumValue(ConsumedQuota_billing_model.class)); });
     ...
     */
    @javax.annotation.Nonnull
    public void setBillingModel(@javax.annotation.Nullable final ConsumedQuota_billing_model value) {
