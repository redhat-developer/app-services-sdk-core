...
public class PullSecretRequest implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private Map<String, Object> additionalData;
    /** The external_resource_id property */
    private String externalResourceId;
    /**
     * Instantiates a new PullSecretRequest and sets the default values.
     * @return a void
     */
     ...
     * @return a PullSecretRequest
     */
    @javax.annotation.Nonnull
    public static PullSecretRequest createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new PullSecretRequest();
    }
    /**
