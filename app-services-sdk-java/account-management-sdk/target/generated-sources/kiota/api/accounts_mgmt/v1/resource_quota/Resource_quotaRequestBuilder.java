package com.openshift.cloud.api.accountmanagement.api.accounts_mgmt.v1.resource_quota;
...
public class Resource_quotaRequestBuilder {
    ...
    public Resource_quotaRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/resource_quota{?page*,size*,search*,orderBy*}";
