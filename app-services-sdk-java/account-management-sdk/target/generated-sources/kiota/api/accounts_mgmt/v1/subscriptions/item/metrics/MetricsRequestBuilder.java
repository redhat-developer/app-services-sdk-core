package com.openshift.cloud.api.accountmanagement.api.accounts_mgmt.v1.subscriptions.item.metrics;

import com.microsoft.kiota.RequestAdapter;
import java.util.HashMap;
import java.util.Objects;
/**
 * Builds and executes requests for operations under /api/accounts_mgmt/v1/subscriptions/{id}/metrics
 */
public class MetricsRequestBuilder {
    ...
    public MetricsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/subscriptions/{id}/metrics";
