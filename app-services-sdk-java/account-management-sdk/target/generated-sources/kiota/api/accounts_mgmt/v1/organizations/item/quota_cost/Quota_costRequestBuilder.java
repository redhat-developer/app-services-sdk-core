package com.openshift.cloud.api.accountmanagement.api.accounts_mgmt.v1.organizations.item.quota_cost;
...
/**
 * Builds and executes requests for operations under /api/accounts_mgmt/v1/organizations/{orgId}/quota_cost
 */
public class Quota_costRequestBuilder {
    ...
    public Quota_costRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/organizations/{orgId}/quota_cost{?search*,fetchRelatedResources*,forceRecalc*,fetchCloudAccounts*}";
