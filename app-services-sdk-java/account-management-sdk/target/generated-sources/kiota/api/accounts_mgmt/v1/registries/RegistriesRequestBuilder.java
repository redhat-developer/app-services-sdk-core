package com.openshift.cloud.api.accountmanagement.api.accounts_mgmt.v1.registries;
...
import com.openshift.cloud.api.accountmanagement.models.RegistryList;
...
public class RegistriesRequestBuilder {
    ...
    public RegistriesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/registries{?page*,size*,search*,orderBy*}";
