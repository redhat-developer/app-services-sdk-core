package com.openshift.cloud.api.accountmanagement.api.accounts_mgmt.v1.errors;
...
import com.openshift.cloud.api.accountmanagement.models.ErrorList;
...
/**
 * Builds and executes requests for operations under /api/accounts_mgmt/v1/errors
 */
public class ErrorsRequestBuilder {
    ...
    public ErrorsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/errors{?page*,size*,search*}";
