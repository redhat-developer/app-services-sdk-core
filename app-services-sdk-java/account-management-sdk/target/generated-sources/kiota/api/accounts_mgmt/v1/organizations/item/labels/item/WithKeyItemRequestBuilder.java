package com.openshift.cloud.api.accountmanagement.api.accounts_mgmt.v1.organizations.item.labels.item;
...
/**
 * Builds and executes requests for operations under /api/accounts_mgmt/v1/organizations/{id}/labels/{key}
 */
public class WithKeyItemRequestBuilder {
    ...
    public WithKeyItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/organizations/{id}/labels/{key}";
