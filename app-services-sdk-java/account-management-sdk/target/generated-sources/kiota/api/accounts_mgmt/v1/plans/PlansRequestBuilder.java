package com.openshift.cloud.api.accountmanagement.api.accounts_mgmt.v1.plans;
...
import com.openshift.cloud.api.accountmanagement.models.PlanList;
...
/**
 * Builds and executes requests for operations under /api/accounts_mgmt/v1/plans
 */
public class PlansRequestBuilder {
    ...
    public PlansRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/plans{?page*,size*,search*}";
    ...
    /**
     * Get all plans
     * @return a CompletableFuture of PlanList
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PlanList> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, PlanList::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<PlanList> executionException = new java.util.concurrent.CompletableFuture<PlanList>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<PlanList> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
