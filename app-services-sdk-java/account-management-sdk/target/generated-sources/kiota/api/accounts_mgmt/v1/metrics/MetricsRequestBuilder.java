package com.openshift.cloud.api.accountmanagement.api.accounts_mgmt.v1.metrics;
...
import com.openshift.cloud.api.accountmanagement.models.MetricsList;
...
/**
 * Builds and executes requests for operations under /api/accounts_mgmt/v1/metrics
 */
public class MetricsRequestBuilder {
    ...
    public MetricsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/metrics{?search*}";
     ...
     * @return a CompletableFuture of MetricsList
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<MetricsList> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, MetricsList::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<MetricsList> executionException = new java.util.concurrent.CompletableFuture<MetricsList>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<MetricsList> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
