package com.openshift.cloud.api.accountmanagement.api.accounts_mgmt.v1.errors.item;
...
/**
 * Builds and executes requests for operations under /api/accounts_mgmt/v1/errors/{id}
 */
public class ErrorsItemRequestBuilder {
    ...
    public ErrorsItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/errors/{id}";
