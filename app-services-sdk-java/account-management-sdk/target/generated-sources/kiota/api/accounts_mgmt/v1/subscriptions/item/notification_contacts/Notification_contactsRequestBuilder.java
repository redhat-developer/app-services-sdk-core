package com.openshift.cloud.api.accountmanagement.api.accounts_mgmt.v1.subscriptions.item.notification_contacts;
...
import com.openshift.cloud.api.accountmanagement.models.NotificationContactCreateRequest;
...
/**
 * Builds and executes requests for operations under /api/accounts_mgmt/v1/subscriptions/{subId}/notification_contacts
 */
public class Notification_contactsRequestBuilder {
    ...
    /**
     * Instantiates a new Notification_contactsRequestBuilder and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     * @return a void
     */
    @javax.annotation.Nullable
    public Notification_contactsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        Objects.requireNonNull(pathParameters);
        Objects.requireNonNull(requestAdapter);
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/subscriptions/{subId}/notification_contacts{?page*,size*,search*,fields*,orderBy*}";
     ...
     */
    @javax.annotation.Nullable
    public Notification_contactsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/subscriptions/{subId}/notification_contacts{?page*,size*,search*,fields*,orderBy*}";
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Account> post(@javax.annotation.Nonnull final NotificationContactCreateRequest body) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Account> post(@javax.annotation.Nonnull final NotificationContactCreateRequest body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final NotificationContactCreateRequest body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final NotificationContactCreateRequest body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
