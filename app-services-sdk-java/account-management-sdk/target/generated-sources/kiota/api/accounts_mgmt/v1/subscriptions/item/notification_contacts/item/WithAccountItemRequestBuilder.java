package com.openshift.cloud.api.accountmanagement.api.accounts_mgmt.v1.subscriptions.item.notification_contacts.item;
...
/**
 * Builds and executes requests for operations under /api/accounts_mgmt/v1/subscriptions/{subId}/notification_contacts/{accountId}
 */
public class WithAccountItemRequestBuilder {
    ...
    public WithAccountItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/subscriptions/{subId}/notification_contacts/{accountId}";
