package com.openshift.cloud.api.accountmanagement.api.accounts_mgmt.v1.organizations.item.labels;
...
import com.openshift.cloud.api.accountmanagement.models.LabelList;
...
/**
 * Builds and executes requests for operations under /api/accounts_mgmt/v1/organizations/{id}/labels
 */
public class LabelsRequestBuilder {
    ...
    public LabelsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/organizations/{id}/labels{?page*,size*,search*,orderBy*}";
     ...
     * @return a CompletableFuture of LabelList
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<LabelList> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, LabelList::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<LabelList> executionException = new java.util.concurrent.CompletableFuture<LabelList>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<LabelList> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Label> post(@javax.annotation.Nonnull final Label body) {
        try {
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<Label> post(@javax.annotation.Nonnull final Label body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final Label body) throws URISyntaxException {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final Label body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
        final RequestInformation requestInfo = new RequestInformation();
