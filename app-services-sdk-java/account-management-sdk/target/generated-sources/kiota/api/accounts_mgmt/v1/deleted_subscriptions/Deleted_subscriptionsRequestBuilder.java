package com.openshift.cloud.api.accountmanagement.api.accounts_mgmt.v1.deleted_subscriptions;
...
import com.openshift.cloud.api.accountmanagement.models.DeletedSubscriptionList;
 ...
 */
public class Deleted_subscriptionsRequestBuilder {
    ...
    public Deleted_subscriptionsRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        Objects.requireNonNull(pathParameters);
        Objects.requireNonNull(requestAdapter);
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/deleted_subscriptions{?page*,size*,search*,orderBy*}";
     ...
     */
    @javax.annotation.Nullable
    public Deleted_subscriptionsRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/deleted_subscriptions{?page*,size*,search*,orderBy*}";
     ...
     * @return a CompletableFuture of DeletedSubscriptionList
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeletedSubscriptionList> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, DeletedSubscriptionList::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<DeletedSubscriptionList> executionException = new java.util.concurrent.CompletableFuture<DeletedSubscriptionList>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<DeletedSubscriptionList> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
