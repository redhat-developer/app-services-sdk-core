package com.openshift.cloud.api.accountmanagement.api.accounts_mgmt.v1.reserved_resources;
...
/**
 * Builds and executes requests for operations under /api/accounts_mgmt/v1/reserved_resources
 */
public class Reserved_resourcesRequestBuilder {
    ...
    public Reserved_resourcesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/reserved_resources{?page*,size*,search*,orderBy*}";
