package com.openshift.cloud.api.accountmanagement.api.accounts_mgmt.v1.current_account;
 ...
 */
public class Current_accountRequestBuilder {
    ...
    public Current_accountRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        Objects.requireNonNull(pathParameters);
        Objects.requireNonNull(requestAdapter);
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/current_account{?fetchLabels*}";
     ...
     */
    @javax.annotation.Nullable
    public Current_accountRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/api/accounts_mgmt/v1/current_account{?fetchLabels*}";
