package com.openshift.cloud.api.connector.api.connector_mgmt.v1.kafka_connector_types;
...
import com.openshift.cloud.api.connector.api.connector_mgmt.v1.kafka_connector_types.labels.LabelsRequestBuilder;
...
/**
 * Builds and executes requests for operations under /api/connector_mgmt/v1/kafka_connector_types
 */
public class Kafka_connector_typesRequestBuilder {
    /** The labels property */
    ...
    /**
     * Instantiates a new Kafka_connector_typesRequestBuilder and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     * @return a void
     */
    @javax.annotation.Nullable
    public Kafka_connector_typesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        Objects.requireNonNull(pathParameters);
        Objects.requireNonNull(requestAdapter);
        this.urlTemplate = "{+baseurl}/api/connector_mgmt/v1/kafka_connector_types{?page*,size*,orderBy*,search*}";
     ...
     */
    @javax.annotation.Nullable
    public Kafka_connector_typesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/api/connector_mgmt/v1/kafka_connector_types{?page*,size*,orderBy*,search*}";
     ...
     * @return a CompletableFuture of ConnectorTypeList
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ConnectorTypeList> get() {
        try {
            final RequestInformation requestInfo = toGetRequestInformation(null);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
            errorMapping.put("401", Error::createFromDiscriminatorValue);
            errorMapping.put("500", Error::createFromDiscriminatorValue);
            return this.requestAdapter.sendAsync(requestInfo, ConnectorTypeList::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<ConnectorTypeList> executionException = new java.util.concurrent.CompletableFuture<ConnectorTypeList>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ConnectorTypeList> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
