package com.openshift.cloud.api.connector.api.connector_mgmt.v1.kafka_connector_namespaces;
...
import com.openshift.cloud.api.connector.api.connector_mgmt.v1.kafka_connector_namespaces.eval.EvalRequestBuilder;
...
/**
 * Builds and executes requests for operations under /api/connector_mgmt/v1/kafka_connector_namespaces
 */
public class Kafka_connector_namespacesRequestBuilder {
    /** The eval property */
    @javax.annotation.Nonnull
    public EvalRequestBuilder eval() {
        return new EvalRequestBuilder(pathParameters, requestAdapter);
    }
    ...
    /**
     * Instantiates a new Kafka_connector_namespacesRequestBuilder and sets the default values.
     * @param pathParameters Path parameters for the request
     * @param requestAdapter The request adapter to use to execute the requests.
     * @return a void
     */
    @javax.annotation.Nullable
    public Kafka_connector_namespacesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        Objects.requireNonNull(pathParameters);
        Objects.requireNonNull(requestAdapter);
        this.urlTemplate = "{+baseurl}/api/connector_mgmt/v1/kafka_connector_namespaces{?page*,size*,orderBy*,search*}";
     ...
     */
    @javax.annotation.Nullable
    public Kafka_connector_namespacesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/api/connector_mgmt/v1/kafka_connector_namespaces{?page*,size*,orderBy*,search*}";
     ...
     * @return a CompletableFuture of ConnectorNamespaceList
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ConnectorNamespaceList> get() {
        try {
            final RequestInformation requestInfo = toGetRequestInformation(null);
            final HashMap<String, ParsableFactory<? extends Parsable>> errorMapping = new HashMap<String, ParsableFactory<? extends Parsable>>();
            errorMapping.put("401", Error::createFromDiscriminatorValue);
            errorMapping.put("500", Error::createFromDiscriminatorValue);
            return this.requestAdapter.sendAsync(requestInfo, ConnectorNamespaceList::createFromDiscriminatorValue, errorMapping);
        } catch (URISyntaxException ex) {
            final java.util.concurrent.CompletableFuture<ConnectorNamespaceList> executionException = new java.util.concurrent.CompletableFuture<ConnectorNamespaceList>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ConnectorNamespaceList> get(@javax.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        try {
