package com.openshift.cloud.api.connector.api.connector_mgmt.v1.kafka_connector_clusters.item.namespaces;
...
/**
 * Builds and executes requests for operations under /api/connector_mgmt/v1/kafka_connector_clusters/{connector_cluster_id}/namespaces
 */
public class NamespacesRequestBuilder {
    ...
    public NamespacesRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        Objects.requireNonNull(pathParameters);
        Objects.requireNonNull(requestAdapter);
        this.urlTemplate = "{+baseurl}/api/connector_mgmt/v1/kafka_connector_clusters/{connector_cluster_id}/namespaces{?page*,size*,orderBy*,search*}";
     ...
     */
    @javax.annotation.Nullable
    public NamespacesRequestBuilder(@javax.annotation.Nonnull final String rawUrl, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        this.urlTemplate = "{+baseurl}/api/connector_mgmt/v1/kafka_connector_clusters/{connector_cluster_id}/namespaces{?page*,size*,orderBy*,search*}";
