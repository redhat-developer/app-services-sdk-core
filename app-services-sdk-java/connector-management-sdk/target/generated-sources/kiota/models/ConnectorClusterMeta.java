...
public class ConnectorClusterMeta extends ObjectMeta implements Parsable {
    /** Name-value string annotations for resource */
    private ConnectorResourceAnnotations annotations;
    /** The name property */
    private String name;
    /**
     * Instantiates a new ConnectorClusterMeta and sets the default values.
     * @return a void
     */
     ...
     * @return a ConnectorClusterMeta
     */
    @javax.annotation.Nonnull
    public static ConnectorClusterMeta createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new ConnectorClusterMeta();
    }
    /**
