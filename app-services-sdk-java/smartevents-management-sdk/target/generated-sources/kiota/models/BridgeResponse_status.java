...
public enum BridgeResponse_status implements ValuedEnum {
    Accepted("accepted"),
    Preparing("preparing"),
    ...
    BridgeResponse_status(final String value) {
        this.value = value;
    }
    @javax.annotation.Nonnull
    public String getValue() { return this.value; }
    @javax.annotation.Nullable
    public static BridgeResponse_status forValue(@javax.annotation.Nonnull final String searchValue) {
