...
public class ErrorListResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private Map<String, Object> additionalData;
    /** The items property */
    private java.util.List<Error> items;
    /** The kind property */
    private String kind;
    /** The page property */
    private Long page;
    ...
    private Long total;
    /**
     * Instantiates a new ErrorListResponse and sets the default values.
     * @return a void
     */
     ...
     * @return a ErrorListResponse
     */
    @javax.annotation.Nonnull
    public static ErrorListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(Error::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nullable
    public java.util.List<Error> getItems() {
        return this.items;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setItems(@javax.annotation.Nullable final java.util.List<Error> value) {
        this.items = value;
    }
    /**
