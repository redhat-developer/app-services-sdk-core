...
public class SourceConnectorResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private Map<String, Object> additionalData;
    /** The Connector configuration payload */
    private SourceConnectorResponse_connector connector;
    /** The connector type */
    ...
    /** The status property */
    private SourceConnectorResponse_status status;
    /** A detailed status message in case there is a problem with the connector */
    private String statusMessage;
    /** The submitted_at property */
    private OffsetDateTime submittedAt;
    /**
     * Instantiates a new SourceConnectorResponse and sets the default values.
     * @return a void
     */
     ...
     * @return a SourceConnectorResponse
     */
    @javax.annotation.Nonnull
    public static SourceConnectorResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new SourceConnectorResponse();
    }
    /**
     ...
     * @return a SourceConnectorResponse_connector
     */
    @javax.annotation.Nullable
    public SourceConnectorResponse_connector getConnector() {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("connector", (n) -> { this.setConnector(n.getObjectValue(SourceConnectorResponse_connector::createFromDiscriminatorValue)); });
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(SourceConnectorResponse_status.class)); });
     ...
     * @return a SourceConnectorResponse_status
     */
    @javax.annotation.Nullable
    public SourceConnectorResponse_status getStatus() {
        return this.status;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setConnector(@javax.annotation.Nullable final SourceConnectorResponse_connector value) {
     ...
     */
    @javax.annotation.Nonnull
    public void setStatus(@javax.annotation.Nullable final SourceConnectorResponse_status value) {
        this.status = value;
    }
    /**
