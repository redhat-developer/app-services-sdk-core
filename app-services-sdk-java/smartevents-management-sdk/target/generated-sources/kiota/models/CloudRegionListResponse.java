...
public class CloudRegionListResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private Map<String, Object> additionalData;
    /** The items property */
    private java.util.List<CloudRegionResponse> items;
    /** The kind property */
    private String kind;
    /** The page property */
    private Long page;
    ...
    private Long total;
    /**
     * Instantiates a new CloudRegionListResponse and sets the default values.
     * @return a void
     */
     ...
     * @return a CloudRegionListResponse
     */
    @javax.annotation.Nonnull
    public static CloudRegionListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new CloudRegionListResponse();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(CloudRegionResponse::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nullable
    public java.util.List<CloudRegionResponse> getItems() {
        return this.items;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setItems(@javax.annotation.Nullable final java.util.List<CloudRegionResponse> value) {
        this.items = value;
    }
    /**
