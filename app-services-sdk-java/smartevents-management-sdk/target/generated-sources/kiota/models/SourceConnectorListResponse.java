...
public class SourceConnectorListResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private Map<String, Object> additionalData;
    /** The items property */
    private java.util.List<SourceConnectorResponse> items;
    /** The kind property */
    private String kind;
    /** The page property */
    private Long page;
    ...
    private Long total;
    /**
     * Instantiates a new SourceConnectorListResponse and sets the default values.
     * @return a void
     */
     ...
     * @return a SourceConnectorListResponse
     */
    @javax.annotation.Nonnull
    public static SourceConnectorListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new SourceConnectorListResponse();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(SourceConnectorResponse::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nullable
    public java.util.List<SourceConnectorResponse> getItems() {
        return this.items;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setItems(@javax.annotation.Nullable final java.util.List<SourceConnectorResponse> value) {
        this.items = value;
    }
    /**
