...
public class BridgeResponse implements AdditionalDataHolder, Parsable {
     ...
     * @return a BridgeResponse
     */
    @javax.annotation.Nonnull
    public static BridgeResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
    ...
    /**
     * Gets the endpoint property value. The HTTPS endpoint on which the bridge accepts events
     * @return a string
     */
    @javax.annotation.Nullable
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(BridgeResponse_status.class)); });
     ...
     * @return a BridgeResponse_status
     */
    @javax.annotation.Nullable
    public BridgeResponse_status getStatus() {
        return this.status;
    }
    /**
     * Gets the status_message property value. A detailed status message in case there is a problem with the bridge
     * @return a string
     */
    @javax.annotation.Nullable
    ...
    /**
     * Sets the endpoint property value. The HTTPS endpoint on which the bridge accepts events
     ...
     */
    @javax.annotation.Nonnull
    public void setStatus(@javax.annotation.Nullable final BridgeResponse_status value) {
        this.status = value;
    }
    /**
     * Sets the status_message property value. A detailed status message in case there is a problem with the bridge
