...
public class SinkConnectorListResponse implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private Map<String, Object> additionalData;
    /** The items property */
    private java.util.List<SinkConnectorResponse> items;
    /** The kind property */
    private String kind;
    /** The page property */
    private Long page;
    ...
    private Long total;
    /**
     * Instantiates a new SinkConnectorListResponse and sets the default values.
     * @return a void
     */
     ...
     * @return a SinkConnectorListResponse
     */
    @javax.annotation.Nonnull
    public static SinkConnectorListResponse createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new SinkConnectorListResponse();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("items", (n) -> { this.setItems(n.getCollectionOfObjectValues(SinkConnectorResponse::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nullable
    public java.util.List<SinkConnectorResponse> getItems() {
        return this.items;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setItems(@javax.annotation.Nullable final java.util.List<SinkConnectorResponse> value) {
        this.items = value;
    }
    /**
