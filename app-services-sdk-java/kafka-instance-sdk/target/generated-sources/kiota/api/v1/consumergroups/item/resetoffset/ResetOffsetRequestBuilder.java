...
public class ResetOffsetRequestBuilder {
    ...
    public ResetOffsetRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
    ...
    public java.util.concurrent.CompletableFuture<ConsumerGroupResetOffsetResult> post(@javax.annotation.Nonnull final ConsumerGroupResetOffsetParameters body) {
        try {
            ...
            final java.util.concurrent.CompletableFuture<ConsumerGroupResetOffsetResult> executionException = new java.util.concurrent.CompletableFuture<ConsumerGroupResetOffsetResult>();
     ...
     */
    @javax.annotation.Nonnull
    public java.util.concurrent.CompletableFuture<ConsumerGroupResetOffsetResult> post(@javax.annotation.Nonnull final ConsumerGroupResetOffsetParameters body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
     ...
     */
    @javax.annotation.Nonnull
    public RequestInformation toPostRequestInformation(@javax.annotation.Nonnull final ConsumerGroupResetOffsetParameters body, @javax.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) throws URISyntaxException {
        Objects.requireNonNull(body);
