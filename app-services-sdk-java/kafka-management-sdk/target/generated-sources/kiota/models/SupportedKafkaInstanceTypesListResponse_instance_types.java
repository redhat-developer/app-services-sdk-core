 ...
 */
public class SupportedKafkaInstanceTypesListResponse_instance_types implements AdditionalDataHolder, Parsable {
    ...
    private java.util.List<SupportedKafkaInstanceTypesListResponse_instance_types_sizes> sizes;
    ...
    /**
     * Instantiates a new SupportedKafkaInstanceTypesListResponse_instance_types and sets the default values.
     * @return a void
     */
    @javax.annotation.Nullable
    public SupportedKafkaInstanceTypesListResponse_instance_types() {
    ...
    public static SupportedKafkaInstanceTypesListResponse_instance_types createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new SupportedKafkaInstanceTypesListResponse_instance_types();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("sizes", (n) -> { this.setSizes(n.getCollectionOfObjectValues(SupportedKafkaInstanceTypesListResponse_instance_types_sizes::createFromDiscriminatorValue)); });
     ...
     * @return a SupportedKafkaInstanceTypesListResponse_instance_types_sizes
     */
    @javax.annotation.Nullable
    public java.util.List<SupportedKafkaInstanceTypesListResponse_instance_types_sizes> getSizes() {
        return this.sizes;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setSizes(@javax.annotation.Nullable final java.util.List<SupportedKafkaInstanceTypesListResponse_instance_types_sizes> value) {
        this.sizes = value;
    }
    /**
