 ...
 */
public class SupportedKafkaInstanceType implements AdditionalDataHolder, Parsable {
    ...
    private java.util.List<SupportedKafkaInstanceType_sizes> sizes;
    ...
    /**
     * Instantiates a new SupportedKafkaInstanceType and sets the default values.
     * @return a void
     */
     ...
     * @return a SupportedKafkaInstanceType
     */
    @javax.annotation.Nonnull
    public static SupportedKafkaInstanceType createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new SupportedKafkaInstanceType();
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("sizes", (n) -> { this.setSizes(n.getCollectionOfObjectValues(SupportedKafkaInstanceType_sizes::createFromDiscriminatorValue)); });
     ...
     */
    @javax.annotation.Nullable
    public java.util.List<SupportedKafkaInstanceType_sizes> getSizes() {
        return this.sizes;
    }
    /**
     ...
     */
    @javax.annotation.Nonnull
    public void setSizes(@javax.annotation.Nullable final java.util.List<SupportedKafkaInstanceType_sizes> value) {
        this.sizes = value;
    }
    /**
