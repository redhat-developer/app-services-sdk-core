 ...
 */
public class CloudRegionList_items implements AdditionalDataHolder, Parsable {
    ...
    private String kind;
    /**
     * Instantiates a new CloudRegionList_items and sets the default values.
     * @return a void
     */
    @javax.annotation.Nullable
    public CloudRegionList_items() {
    ...
    public static CloudRegionList_items createFromDiscriminatorValue(@javax.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new CloudRegionList_items();
    }
    /**
