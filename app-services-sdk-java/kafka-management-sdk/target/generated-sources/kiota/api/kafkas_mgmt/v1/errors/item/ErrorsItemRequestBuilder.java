package com.openshift.cloud.api.kas.api.kafkas_mgmt.v1.errors.item;
...
/**
 * Builds and executes requests for operations under /api/kafkas_mgmt/v1/errors/{id}
 */
public class ErrorsItemRequestBuilder {
    ...
    public ErrorsItemRequestBuilder(@javax.annotation.Nonnull final HashMap<String, Object> pathParameters, @javax.annotation.Nonnull final RequestAdapter requestAdapter) {
        ...
        this.urlTemplate = "{+baseurl}/api/kafkas_mgmt/v1/errors/{id}";
    ...
    public java.util.concurrent.CompletableFuture<Error> get() {
        try {
            ...
            return this.requestAdapter.sendAsync(requestInfo, Error::createFromDiscriminatorValue, null);
